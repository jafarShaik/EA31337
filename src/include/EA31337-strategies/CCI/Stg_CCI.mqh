...
INPUT ENUM_TRAIL_TYPE CCI_TrailingStopMethod = 7; // Trail stop method
INPUT ENUM_TRAIL_TYPE CCI_TrailingProfitMethod = -9; // Trail profit method
INPUT int CCI_Period_M1 = 2; // Period for M1
INPUT int CCI_Period_M5 = 30; // Period for M5
INPUT int CCI_Period_M15 = 6; // Period for M15
INPUT int CCI_Period_M30 = 10; // Period for M30
INPUT ENUM_APPLIED_PRICE CCI_Applied_Price = (ENUM_APPLIED_PRICE) 0; // Applied Price
INPUT double CCI_SignalLevel = 115; // Signal level (100 by default)
INPUT int CCI1_SignalMethod = -63; // Signal method for M1 (0-63)
INPUT int CCI5_SignalMethod = -27; // Signal method for M5 (0-63)
INPUT int CCI15_SignalMethod = -39; // Signal method for M15 (0-63)
INPUT int CCI30_SignalMethod = -43; // Signal method for M30 (0-63)
INPUT int CCI1_OpenCondition1 = 1; // Open condition 1 for M1 (0-1023)
INPUT int CCI1_OpenCondition2 = 1; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT CCI1_CloseCondition = 13; // Close condition for M1
INPUT int CCI5_OpenCondition1 = 680; // Open condition 1 for M5 (0-1023)
INPUT int CCI5_OpenCondition2 = 98; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT CCI5_CloseCondition = 29; // Close condition for M5
INPUT int CCI15_OpenCondition1 = 98; // Open condition 1 for M15 (0-1023)
INPUT int CCI15_OpenCondition2 = 777; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT CCI15_CloseCondition = 13; // Close condition for M15
INPUT int CCI30_OpenCondition1 = 98; // Open condition 1 for M30 (0-1023)
INPUT int CCI30_OpenCondition2 = 777; // Open condition 2 for M30 (0-1023)
INPUT ENUM_MARKET_EVENT CCI30_CloseCondition = 12; // Close condition for M30
