...
INPUT int Alligator_Shift_Jaw = 3; // Jaw Shift
INPUT int Alligator_Shift_Teeth = 7; // Teeth Shift
INPUT int Alligator_Shift_Lips = 3; // Lips Shift
...
INPUT ENUM_TRAIL_TYPE Alligator_TrailingStopMethod = 18; // Trail stop method
INPUT ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = -16; // Trail profit method
INPUT double Alligator_SignalLevel = 0.3; // Signal level
INPUT int Alligator1_SignalMethod = 0; // Signal method for M1 (-63-63)
INPUT int Alligator5_SignalMethod = 8; // Signal method for M5 (-63-63)
INPUT int Alligator15_SignalMethod = 30; // Signal method for M15 (-63-63)
INPUT int Alligator30_SignalMethod = 20; // Signal method for M30 (-63-63)
INPUT int Alligator1_OpenCondition1 = 1; // Open condition 1 for M1 (0-1023)
INPUT int Alligator1_OpenCondition2 = 1; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT Alligator1_CloseCondition = 20; // Close condition for M1
INPUT int Alligator5_OpenCondition1 = 292; // Open condition 1 for M5 (0-1023)
INPUT int Alligator5_OpenCondition2 = 195; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT Alligator5_CloseCondition = 19; // Close condition for M5
INPUT int Alligator15_OpenCondition1 = 195; // Open condition 1 for M15 (0-1023)
INPUT int Alligator15_OpenCondition2 = 680; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT Alligator15_CloseCondition = 29; // Close condition for M15
INPUT int Alligator30_OpenCondition1 = 874; // Open condition 1 for M30 (0-1023)
INPUT int Alligator30_OpenCondition2 = 195; // Open condition 2 for M30 (0-1023)
