...
INPUT int Envelopes_MA_Period_M30 = 4; // Period for M30
...
INPUT int Envelopes_MA_Shift = 1; // MA Shift
INPUT ENUM_APPLIED_PRICE Envelopes_Applied_Price = (ENUM_APPLIED_PRICE) 2; // Applied Price
INPUT int Envelopes_Shift = 1; // Shift
INPUT ENUM_TRAIL_TYPE Envelopes_TrailingStopMethod = 20; // Trail stop method
INPUT ENUM_TRAIL_TYPE Envelopes_TrailingProfitMethod = -14; // Trail profit method
/* @todo INPUT */ int Envelopes_SignalLevel = 0; // Signal level
INPUT int Envelopes1_SignalMethod = 8; // Signal method for M1 (-127-127)
INPUT int Envelopes5_SignalMethod = 69; // Signal method for M5 (-127-127)
INPUT int Envelopes15_SignalMethod = -69; // Signal method for M15 (-127-127)
INPUT int Envelopes30_SignalMethod = 64; // Signal method for M30 (-127-127)
INPUT int Envelopes1_OpenCondition1 = 1; // Open condition 1 for M1 (0-1023)
INPUT int Envelopes1_OpenCondition2 = 98; // Open condition 2 for M1 (0-1023)
...
INPUT ENUM_MARKET_EVENT Envelopes5_CloseCondition = 13; // Close condition for M5
//
INPUT int Envelopes15_OpenCondition1 = 971; // Open condition 1 for M15 (0-1023)
INPUT int Envelopes15_OpenCondition2 = 971; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT Envelopes15_CloseCondition = 1; // Close condition for M15
//
INPUT int Envelopes30_OpenCondition1 = 1; // Open condition 1 for M30 (0-1023)
INPUT int Envelopes30_OpenCondition2 = 98; // Open condition 2 for M30 (0-1023)
INPUT ENUM_MARKET_EVENT Envelopes30_CloseCondition = 31; // Close condition for M30
//
