...
INPUT int WPR_Period_M1 = 16; // Period for M1
INPUT int WPR_Period_M5 = 8; // Period for M5
...
INPUT ENUM_TRAIL_TYPE WPR_TrailingStopMethod = 21; // Trail stop method
INPUT ENUM_TRAIL_TYPE WPR_TrailingProfitMethod = -1; // Trail profit method
INPUT int WPR1_SignalMethod = -29; // Signal method for M1 (-63-63)
INPUT int WPR5_SignalMethod = -44; // Signal method for M5 (-63-63)
INPUT int WPR15_SignalMethod = -55; // Signal method for M15 (-63-63)
...
INPUT ENUM_MARKET_EVENT WPR1_CloseCondition = 3; // Close condition for M1
INPUT int WPR5_OpenCondition1 = 583; // Open condition 1 for M5 (0-1023)
INPUT int WPR5_OpenCondition2 = 98; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT WPR5_CloseCondition = 24; // Close condition for M5
INPUT int WPR15_OpenCondition1 = 486; // Open condition 1 for M15 (0-1023)
INPUT int WPR15_OpenCondition2 = 195; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT WPR15_CloseCondition = 24; // Close condition for M15
INPUT int WPR30_OpenCondition1 = 486; // Open condition 1 for M30 (0-1023)
INPUT int WPR30_OpenCondition2 = 195; // Open condition 2 for M30 (0-1023)
INPUT ENUM_MARKET_EVENT WPR30_CloseCondition = 26; // Close condition for M30
