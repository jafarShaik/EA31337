...
INPUT ENUM_MARKET_EVENT SAR1_CloseCondition = 5; // Close condition for M1
INPUT int SAR5_OpenCondition1 = 583; // Open condition 1 for M1 (0-1023)
INPUT int SAR5_OpenCondition2 = 971; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT SAR5_CloseCondition = 19; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT SAR15_CloseCondition = 29; // Close condition for M15
INPUT int SAR30_OpenCondition1 = 486; // Open condition 1 for M30 (0-1023)
INPUT int SAR30_OpenCondition2 = 680; // Open condition 2 for M30 (0-1023)
