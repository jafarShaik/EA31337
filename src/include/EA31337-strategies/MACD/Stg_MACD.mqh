...
INPUT int MACD_Period_Signal = 9; // Period for signal
INPUT ENUM_APPLIED_PRICE MACD_Applied_Price = (ENUM_APPLIED_PRICE) 6; // Applied Price
INPUT int MACD_Shift = 0; // Shift
INPUT ENUM_TRAIL_TYPE MACD_TrailingStopMethod = 12; // Trail stop method
INPUT ENUM_TRAIL_TYPE MACD_TrailingProfitMethod = -2; // Trail profit method
INPUT double MACD_SignalLevel = -0.4; // Signal level
INPUT int MACD1_SignalMethod = 18; // Signal method for M1 (-31-31)
INPUT int MACD5_SignalMethod = -10; // Signal method for M5 (-31-31)
INPUT int MACD15_SignalMethod = -28; // Signal method for M15 (-31-31)
INPUT int MACD30_SignalMethod = 3; // Signal method for M30 (-31-31)
