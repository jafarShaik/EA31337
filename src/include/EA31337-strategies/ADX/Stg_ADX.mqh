...
INPUT uint ADX_Period_M5 = 12; // Period for M5
INPUT uint ADX_Period_M15 = 48; // Period for M15
INPUT uint ADX_Period_M30 = 32; // Period for M30
INPUT ENUM_APPLIED_PRICE ADX_Applied_Price = (ENUM_APPLIED_PRICE) 6; // Applied Price
INPUT double ADX_SignalLevel = 18.3; // Signal level
...
INPUT int ADX1_OpenCondition1 = 991; // Open condition 1 for M1 (0-1023)
INPUT int ADX1_OpenCondition2 = 991; // Open condition 2 for M1 (0-)
INPUT ENUM_MARKET_EVENT ADX1_CloseCondition = 30; // Close condition for M1
INPUT int ADX5_OpenCondition1 = 441; // Open condition 1 for M5 (0-1023)
INPUT int ADX5_OpenCondition2 = 991; // Open condition 2 for M5 (0-)
INPUT ENUM_MARKET_EVENT ADX5_CloseCondition = 30; // Close condition for M5
...
INPUT int ADX30_OpenCondition1 = 991; // Open condition 1 for M30 (0-)
INPUT int ADX30_OpenCondition2 = 881; // Open condition 2 for M30 (0-)
INPUT ENUM_MARKET_EVENT ADX30_CloseCondition = 30; // Close condition for M30
