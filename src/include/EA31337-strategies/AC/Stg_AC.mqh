...
INPUT ENUM_TRAIL_TYPE AC_TrailingStopMethod = 25; // Trail stop method
INPUT ENUM_TRAIL_TYPE AC_TrailingProfitMethod = 6; // Trail profit method
...
INPUT int AC1_OpenCondition2 = 777; // Open condition 2 for M1 (0-)
INPUT ENUM_MARKET_EVENT AC1_CloseCondition = 20; // Close condition for M1
INPUT int AC5_OpenCondition1 = 583; // Open condition 1 for M5 (0-1023)
INPUT int AC5_OpenCondition2 = 583; // Open condition 2 for M5 (0-)
INPUT ENUM_MARKET_EVENT AC5_CloseCondition = 19; // Close condition for M5
...
INPUT int AC30_OpenCondition1 = 292; // Open condition 1 for M30 (0-)
INPUT int AC30_OpenCondition2 = 195; // Open condition 2 for M30 (0-)
INPUT ENUM_MARKET_EVENT AC30_CloseCondition = 12; // Close condition for M30
