...
INPUT ENUM_TRAIL_TYPE Fractals_TrailingStopMethod = 18; // Trail stop method
...
INPUT int Fractals5_SignalMethod = -2; // Signal method for M5 (-3-3)
...
INPUT ENUM_MARKET_EVENT Fractals5_CloseCondition = 18; // Close condition for M5
INPUT int Fractals15_OpenCondition1 = 486; // Open condition 1 for M15 (0-)
INPUT int Fractals15_OpenCondition2 = 583; // Open condition 2 for M15 (0-)
INPUT ENUM_MARKET_EVENT Fractals15_CloseCondition = 13; // Close condition for M15
INPUT int Fractals30_OpenCondition1 = 195; // Open condition 1 for M30 (0-)
INPUT int Fractals30_OpenCondition2 = 195; // Open condition 2 for M30 (0-)
INPUT ENUM_MARKET_EVENT Fractals30_CloseCondition = 12; // Close condition for M30
