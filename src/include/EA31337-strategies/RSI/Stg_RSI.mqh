...
INPUT int RSI_Period_M15 = 8; // Period for M15
...
INPUT ENUM_TRAIL_TYPE RSI_TrailingStopMethod = -23; // Trail stop method
...
INPUT int RSI15_SignalMethod = -39; // Signal method for M15 (-63-63)
INPUT int RSI30_SignalMethod = -54; // Signal method for M30 (-63-63)
INPUT int RSI1_OpenCondition1 = 292; // Open condition 1 for M1 (0-1023)
INPUT int RSI1_OpenCondition2 = 777; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT RSI1_CloseCondition = 13; // Close condition for M1
INPUT int RSI5_OpenCondition1 = 292; // Open condition 1 for M5 (0-1023)
INPUT int RSI5_OpenCondition2 = 1; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT RSI5_CloseCondition = 33; // Close condition for M5
...
INPUT ENUM_MARKET_EVENT RSI15_CloseCondition = 13; // Close condition for M15
INPUT int RSI30_OpenCondition1 = 1; // Open condition 1 for M30 (0-1023)
INPUT int RSI30_OpenCondition2 = 98; // Open condition 2 for M30 (0-1023)
