...
INPUT int AD1_OpenCondition1 = 111; // Open condition 1 for M1 (0-1023)
INPUT int AD1_OpenCondition2 = 111; // Open condition 2 for M1 (0-)
INPUT ENUM_MARKET_EVENT AD1_CloseCondition = 13; // Close condition for M1
INPUT int AD5_OpenCondition1 = 111; // Open condition 1 for M5 (0-1023)
INPUT int AD5_OpenCondition2 = 991; // Open condition 2 for M5 (0-)
...
INPUT int AD30_OpenCondition1 = 276; // Open condition 1 for M30 (0-)
INPUT int AD30_OpenCondition2 = 111; // Open condition 2 for M30 (0-)
