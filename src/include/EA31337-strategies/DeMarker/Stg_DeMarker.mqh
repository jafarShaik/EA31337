...
INPUT int DeMarker_Period_M1 = 50; // Period for M1
INPUT int DeMarker_Period_M5 = 4; // Period for M5
INPUT int DeMarker_Period_M15 = 10; // Period for M15
INPUT int DeMarker_Period_M30 = 24; // Period for M30
INPUT int DeMarker_Shift = 5; // Shift
INPUT double DeMarker_SignalLevel = 0.4; // Signal level (0.0-0.5)
INPUT ENUM_TRAIL_TYPE DeMarker_TrailingStopMethod = 17; // Trail stop method
INPUT ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = 24; // Trail profit method
INPUT int DeMarker1_SignalMethod = 13; // Signal method for M1 (-31-31)
INPUT int DeMarker5_SignalMethod = -8; // Signal method for M5 (-31-31)
INPUT int DeMarker15_SignalMethod = -15; // Signal method for M15 (-31-31)
INPUT int DeMarker30_SignalMethod = -11; // Signal method for M30 (-31-31)
INPUT int DeMarker1_OpenCondition1 = 971; // Open condition 1 for M1 (0-1023)
INPUT int DeMarker1_OpenCondition2 = 971; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT DeMarker1_CloseCondition = 13; // Close condition for M1
INPUT int DeMarker5_OpenCondition1 = 874; // Open condition 1 for M5 (0-1023)
INPUT int DeMarker5_OpenCondition2 = 971; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT DeMarker5_CloseCondition = 4; // Close condition for M5
INPUT int DeMarker15_OpenCondition1 = 583; // Open condition 1 for M15 (0-1023)
INPUT int DeMarker15_OpenCondition2 = 971; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT DeMarker15_CloseCondition = 13; // Close condition for M15
INPUT int DeMarker30_OpenCondition1 = 583; // Open condition 1 for M30 (0-1023)
INPUT int DeMarker30_OpenCondition2 = 971; // Open condition 2 for M30 (0-1023)
