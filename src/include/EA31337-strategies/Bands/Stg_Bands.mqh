...
INPUT int Bands_Period_M5 = 8; // Period for M5
...
INPUT double Bands_Deviation_M1 = 0.4; // Deviation for M1
INPUT double Bands_Deviation_M5 = 0.4; // Deviation for M5
INPUT double Bands_Deviation_M15 = 0.4; // Deviation for M15
INPUT double Bands_Deviation_M30 = 0.4; // Deviation for M30
INPUT int Bands_HShift = 2; // Horizontal shift
INPUT int Bands_Shift = 0; // Shift (relative to the current bar, 0 - default)
INPUT ENUM_TRAIL_TYPE Bands_TrailingStopMethod = 10; // Trail stop method
INPUT ENUM_TRAIL_TYPE Bands_TrailingProfitMethod = 14; // Trail profit method
INPUT int Bands_SignalLevel = 18; // Signal level
INPUT int Bands1_SignalMethod = 64; // Signal method for M1 (-127-127)
INPUT int Bands5_SignalMethod = 32; // Signal method for M5 (-127-127)
INPUT int Bands15_SignalMethod = 71; // Signal method for M15 (-127-127)
INPUT int Bands30_SignalMethod = 85; // Signal method for M30 (-127-127)
INPUT int Bands1_OpenCondition1 = 98; // Open condition 1 for M1 (0-1023)
INPUT int Bands1_OpenCondition2 = 971; // Open condition 2 for M1 (0-1023)
INPUT ENUM_MARKET_EVENT Bands1_CloseCondition = 13; // Close condition for M1
INPUT int Bands5_OpenCondition1 = 98; // Open condition 1 for M5 (0-1023)
INPUT int Bands5_OpenCondition2 = 971; // Open condition 2 for M5 (0-1023)
INPUT ENUM_MARKET_EVENT Bands5_CloseCondition = 4; // Close condition for M5
INPUT int Bands15_OpenCondition1 = 389; // Open condition 1 for M15 (0-1023)
INPUT int Bands15_OpenCondition2 = 971; // Open condition 2 for M15 (0-1023)
INPUT ENUM_MARKET_EVENT Bands15_CloseCondition = 13; // Close condition for M15
INPUT int Bands30_OpenCondition1 = 389; // Open condition 1 for M30 (0-1023)
INPUT int Bands30_OpenCondition2 = 971; // Open condition 2 for M30 (0-1023)
INPUT ENUM_MARKET_EVENT Bands30_CloseCondition = 12; // Close condition for M30
