...
INPUT int Force_Period_M1 = 6; // Period for M1
INPUT int Force_Period_M5 = 22; // Period for M5
INPUT int Force_Period_M15 = 2; // Period for M15
INPUT int Force_Period_M30 = 10; // Period for M30
...
INPUT double Force_SignalLevel = 0.1; // Signal level
...
INPUT int Force1_OpenCondition2 = 486; // Open condition 2 for M1 (0-)
...
INPUT int Force5_OpenCondition2 = 971; // Open condition 2 for M5 (0-)
...
INPUT int Force30_OpenCondition2 = 195; // Open condition 2 for M30 (0-)
